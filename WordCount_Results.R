...
result_vector<- c(nrow(result1_correct_classified),nrow(result1_incorrect_classified), nrow(result1_na_classified),nrow(result2_correct_classified),nrow(result2_incorrect_classified), nrow(result2_na_classified))

barplot(result_vector, space=1, main="Performance of tagging", sub="no additional improvements", names.arg=c("cor-dict1","incor-dict1","na-dict1","cor-dict2","incor-dict2","na-dict2"))
